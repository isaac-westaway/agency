  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="text-white ml-11 mr-11 my-8">
        <div className="w-fit">
          <RevealAlways>
            <div className="rounded-lg px-3.5 py-2.5 cursor-pointer text-white bg-[#4A6CF7] hover:bg-white hover:text-black hover:z-50 transition ease-in-out duration-200">
              Start developing you website
            </div>
          </RevealAlways>
        </div>
      </section>
        ...
        <RevealOnce>
            <div className="grid grid-cols-3 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 sm:gap-y-16 md:gap-y-16 gap-11 pl-11 pr-11 text-white">
              <div className="py-12 border border-dark-50 rounded-2xl flex flex-col justify-center items-center">
                ...
                <RevealAlways>
                <div className="rounded-lg mt-10 px-3.5 py-2.5 cursor-pointer text-white bg-[#4A6CF7] hover:bg-white hover:text-black hover:z-50 transition ease-in-out duration-200">
              ...
              <div className="py-12 border border-dark-50 rounded-2xl flex flex-col justify-center items-center">
                ...
                <RevealAlways>
                <div className="rounded-lg px-3.5 mt-10 py-2.5 cursor-pointer text-white bg-[#4A6CF7] hover:bg-white hover:text-black hover:z-50 transition ease-in-out duration-200">
                  Start designing your project
                </div>
              </RevealAlways>
              </div>
              <div className="py-12 row-span-2 border border-dark-50 rounded-2xl flex flex-col justify-center items-center backdrop-blur-2xl bg-transparent">
                ...
                <ul className="mt-8 space-y-4 flex-1 text-lg">
                  <li className="flex items-center justify-start leading-6">
                    ...
                    <span className="ml-3 text-white">Unique and Memorable</span>
                  </li>
                  <li className="flex items-center justify-start leading-6">
                    <svg
                      className="h-5 w-5 shrink-0"
                  ...
                  <li className="flex items-center justify-start leading-6">
                    ...
                    <span className="ml-3 text-white">Brand Consistency</span>
                  </li>
                </ul>
                <RevealAlways>
                <div className="rounded-lg px-3.5 mt-10 py-2.5 cursor-pointer text-white bg-[#4A6CF7] hover:bg-white hover:text-black hover:z-50 transition ease-in-out duration-200">
      ...
      <section className="relative text-white border-t-[1px] border-dark-50 ml-11 mr-11" style={{ scrollMarginTop: '100px' }} id="contact">
        <div className="grid grid-cols-2 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-6 sm:gap-0 md:gap-0 lg:gap-0 px-4">
          <div>
            <RevealOnce>
              <div className="h-full relative">
