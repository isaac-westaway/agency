          ...
          <div className="border-l-[1px]  border-dark-50 pl-11 pr-11">
            ...
            <div className="pt-3 leading-6 tracking-wider">
              <div className="font-light flex flex-row w-full">
                <div className="w-full flex items-center animatedUnderline hover:cursor-pointer">
                  Billing Portal
                </div>
              ...
              <div className="font-light mt-2  animatedUnderline w-max hover:cursor-pointer">
                Gallery
              </div>
            </div>
          </div>
