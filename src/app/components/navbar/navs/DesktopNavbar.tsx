      ...
      <div className="flex items-center pl-11 pr-11 justify-between w-full backdrop-blur-lg">
        ...
        <div className="flex flex-row gap-11 items-center">
          ...
          <a
            ...
            className="shrink-0 cursor-pointer flex items-center special-border-name border-[2px] border-dark-50 transition ease-in duration-200 bg-custom-color0.1 rounded-2xl p-2 px-[24px] hover:border-[#FBFAF6] hover:text-[#FBFAF6]"
          >
            Billing portal&nbsp;
