      ...
      <div className="h-full w-full">
        <ul className="flex flex-row justify-evenly items-center">
          ...
          <li className="inline-block">
            <Link
              className="text-lg animatedUnderline cursor-pointer hover:text-white hover:transition hover:duration-200 flex"
              href={"/about-us"}
            >
              Gallery
            </Link>
          ...
          <li className="inline-block">
            <Link
              className="special-border-name text-lg border-[2px] border-stone-800 transition ease-in duration-200 rounded-2xl p-2 px-[24px] hover:border-[#FBFAF6] hover:text-[#FBFAF6] z-50 flex"
              href={"/"}
            >
              Contact
            </Link>
          ...
          <li className="inline-block">
            <Link
              className="special-border-name text-lg border-[2px] border-stone-800 transition ease-in duration-200 rounded-2xl p-2 px-[24px] hover:border-[#FBFAF6] hover:text-[#FBFAF6] flex"
              href={"/test"}
            >
              Billing Portal&nbsp;
