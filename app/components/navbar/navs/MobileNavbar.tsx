    ...
    return (
        <div className="flex items-center justify-around z-40">
            ...
            <div
                className={
                    nav
                        ? 'sm:hidden z-30 absolute top-0 left-0 right-0 bottom-0 flex justify-center w-full pt-[80px] h-screen text-center ease-in duration-300 bg-dark-50'
                        : 'sm:hidden z-30 absolute top-0 left-[100%] right-0 bottom-0 flex justify-center pt-[80px] w-full h-screen text-center ease-in duration-300 bg-dark-50'
            }
            >
            <motion.ul
                initial="hidden"
