...
const PricingCards = () => {
    return (
        <div className="grid lg:grid-cols-1 grid-cols-3 gap-12 lg:gap-8 py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            {pricingPlans.map(plan => (
                <div key={plan.title} className="relative border border-white shadow-lg p-8 bg-white rounded-2xl flex flex-col">
